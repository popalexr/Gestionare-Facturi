                            ...
                            <div id="permissions" class="hidden">
                                <div class="space-y-4 mb-4">
                                    <div class="flex mb-4 py-4">
                                        <input id="permissions-admin" @if(old('admin') == 'on') checked @endif name="admin" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                    ...
                                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                                        <div class="flex items-center p-3">
                                                            <input 
                                                                ...
                                                                @if(old('permission.' . $permission) == 'on') checked @endif
                                                                type="checkbox"
