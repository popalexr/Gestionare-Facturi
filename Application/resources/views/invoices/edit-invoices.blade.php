<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div id="detailsGeneral" class="w-full p-6 bg-white dark:bg-gray-800 rounded-md shadow-md">
                <h3 class="mb-8 text-xl font-bold text-gray-900 dark:text-white">Edit Invoice</h3>
                <form method="POST">
                    @csrf
                    <!-- Input fields -->
                    <div class="w-full">
                        <div class="space-y-6 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="client_name" id="client-search" value="{{ old('client_name', $invoice->getClientName()) }}"
                                ...
                                <input type="hidden" id="client-id" name="client_id" value="{{ old('client_id', $invoice->client_id) }}">
                                @error('client_name')
                            ...
                            <div>
                                ...
                                <select id="currency" name="currency" class="mt-1 w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
                                    <option value="ron" @if(old('currency', $invoice->currency) == 'ron') selected @endif>RON</option>
    ...
    <script>
        let services = @json(old('services', $products));
    </script>
</x-app-layout>
