<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
             ...
             <h3 class="mb-8 ml-12 text-xl font-bold text-gray-900 dark:text-white">Edit Client</h3>
                            ...
                            <div id="detailsGeneral" class="w-full p-4">
                                ...
                                <div class="space-y-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="cui" id="cui" value="{{ old('cui', $client->cui) }}"
                                            class="mt-1 w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
                                    ...
                                    <select name="client_type" id="client_type"
                                        class="mt-1 w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
                                        <option value="individual" @if(old('client_type', $client->client_type) == 'individual') checked @endif>Individual</option>
                                        <option value="company" @if(old('client_type', $client->client_type) == 'company') @endif>Company</option>
                                    </select>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="county" id="county" value="{{ old('county', $client->county) }}"
                                            class="mt-1 w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
...
<script>
    let contacts = @json(old('contacts', $contacts));
</script>
</x-app-layout>
