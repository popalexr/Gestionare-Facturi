                        ...
                        <div class="w-full">
                            ...
                            <div id="detailsGeneral">
                                <div class="flex flex-col items-center space-y-4">
                                    ...
                                    <div>
                                        <label for="city" class="block text-sm font-medium text-gray-700 dark:text-gray-200 text-center">City</label>
                                        <input type="text" name="city" id="city"
                                            class="mt-2 w-64 py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
                                    </div>
                                    <div>
                                        <label for="country" class="block text-sm font-medium text-gray-700 dark:text-gray-200 text-center">Country</label>
                                        <input type="text" name="country" id="country"
                                            class="mt-2 w-64 py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300">
                                    </div>
                                    <div>
                                        <label for="county" class="block text-sm font-medium text-gray-700 dark:text-gray-200 text-center">County</label>
