      ...
      <div class="flex items-center">
          ...
          <div class="flex items-center space-x-4">
              ...
              <div x-data="{ dropdownOpen: false }" class="relative">
                  <button @click="dropdownOpen = !dropdownOpen" class="flex items-center text-sm rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                  ...
                  <div x-show="dropdownOpen" @click.outside="dropdownOpen = false" class="absolute right-0 z-50 mt-2 w-48 bg-white rounded shadow-lg dark:bg-gray-700">
